  ...
  return (
    <section>
      ...
      <div className="flex justify-center">
        <div className="max-w-[1300px] mx-12 flex justify-center flex-wrap gap-12">
          ...
          <CardBenefits icon={funil} title="Tráfego pago">
            Captação de clientes ultra qualificados, utilizando Google Ads e
            Meta Ads para direcionar o seu investimento e maximizar o alcance do
            seu negócio.
          </CardBenefits>
          <CardBenefits icon={gestao} title="Pipelines de CRM">
            Facilita o acompanhamento de leads e a gestão de relacionamentos,
            para uma conversão eficaz e aumento de fidelização de clientes.
          </CardBenefits>
          ...
          <CardBenefits icon={garantido} title="Garantia incondicional">
            Se não ouver resultados obtidos após nosso serviço dentro do período
            estipulado em nosso contrato, comprometemo-nos a devolver
            integralmente o valor do seu investimento.
          </CardBenefits>
        </div>
      </div>
    </section>
